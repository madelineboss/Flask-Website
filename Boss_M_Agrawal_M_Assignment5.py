...
>>>>>>> 6decdde (After lengthy debugging in linprog, Boss_M_Agrawal_M_Assignment6.py holds the fixes, along with a lot of mess that needs to be cleared. The important part is that it works.)
	if not session.get('logged_in'):
		return render_template('login.html')
